...
// va(__DIR__);	string(31) "H:\webapp\www\thinkPHP\ThinkPHP"
defined('APP_PATH')     or define('APP_PATH',       dirname($_SERVER['SCRIPT_FILENAME']).'/');
// va(dirname($_SERVER['SCRIPT_FILENAME']));	string(22) "H:/webapp/www/thinkPHP"
...
defined('LIB_PATH')     or define('LIB_PATH',       realpath(THINK_PATH.'Library').'/'); // 系统核心类库目录	realpath函数返回绝对路径
